...
javac --module-path "%javafxHome%" --upgrade-module-path "%logPath%" --add-modules ALL-MODULE-PATH %utils% %graph% %pieces% %game% %requests% %commandProviders% %javafx% %console% %Main%